...
abstract class CloudFunctions {
  ...
  static const userSetOnboardingCompleted = 'userSetOnboardingCompleted';
  static const userSetTimezone = 'userSetTimezone';
...
abstract class CloudFunctionsProvider with ProviderLoggy {
  final _cloudFunctions = FirebaseFunctions.instanceFor(region: 'europe-west1');
