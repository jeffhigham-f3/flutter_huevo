...
import 'package:flutter_huevo/core/ui/input/image_picker_bottom_sheet.dart';

class PickedImage {
  const PickedImage({required this.filePath, required this.bytes});

  final String filePath;
  final Uint8List bytes;
}

typedef LocalImageBuilder =
    Widget Function(BuildContext context, Uint8List bytes);

typedef NetworkImageBuilder = Widget Function(BuildContext context, String url);
...
class ImagePickerContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      borderRadius: const BorderRadius.all(Radius.circular(1_000)),
