...
exports.deleteAccount = onCall(options, user.deleteAccount);
exports.userSetTimezone = onCall(options, user.userSetTimezone);
exports.userSetOnboardingCompleted = onCall(options, user.userSetOnboardingCompleted);
